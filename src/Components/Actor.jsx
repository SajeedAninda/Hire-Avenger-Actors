export default function Actor({ actors, handleHire }) {
    let cardStyle = {
    ...
    return (
        <div>
            <div style={cardStyle} className="card-container bg flex flex-col justify-center items-center space-y-4 rounded-xl p-4">
                ...
                <button onClick={() => handleHire(actors)} className="px-4 py-2 bg-black text-white rounded-2xl text-lg font-bold">Hire this Star</button>
            </div>
        </div>
    );
}
